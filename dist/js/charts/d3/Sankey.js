  ...
  var defaults =
  {
    ...
    'columnTitle'        : dex.config.text({
        'x'                        : function (d) {
          ...
          var nodeWidth = (typeof userConfig.mouseout.node !== 'undefined' &&
          typeof userConfig.mouseout !== 'undefined' &&
          typeof userConfig.mouseout.node.rectangle !== 'undefined' &&
          typeof userConfig.mouseout.node.rectangle.width !== 'undefined') ?
            userConfig.mouseout.node.rectangle.width : defaults.mouseout.node.rectangle.width;

          var nodePadding = (typeof userConfig.mouseout.node !== 'undefined' &&
          typeof userConfig.mouseout.node.padding !== 'undefined') ?
    ...
    'mouseout'           : {
      'link' : {
        ...
        'fill'      : {'fill' : 'none', 'fillOpacity' : 0.4},
        'curvature' : 0.5
      },
      'node' : {
        'padding'   : 4,
